      ...
      <div className={styles.wrap}>
        ...
        <table className={styles.metaTable}>
          <tbody>
            <tr>
              <th>Documento</th>
              <td>Política de Privacidade — Sistema de Gestão de Segurança (SGS)</td>
            </tr>
            <tr>
              <th>Versão</th>
              <td>{policyVersion}</td>
        ...
        {hasMissingLegalInfo && (
          <p className={styles.notice}>
            <strong>Dados institucionais incompletos.</strong> A estrutura da política está
            pronta, mas a publicação definitiva depende do preenchimento completo dos campos
        ...
        <nav className={styles.toc} aria-label="Índice">
          ...
          <ol>
            <li><a href="#escopo">1. Escopo e agentes de tratamento</a></li>
            <li><a href="#dados">2. Categorias de dados tratados</a></li>
            <li><a href="#saude">3. Dados de saúde ocupacional</a></li>
            <li><a href="#bases">4. Finalidades e bases legais</a></li>
            <li><a href="#compartilhamento">5. Suboperadores e cadeia de processamento</a></li>
            <li><a href="#transferencias">6. Transferências internacionais</a></li>
            <li><a href="#retencao">7. Retenção, descarte e exportação</a></li>
            <li><a href="#cookies">8. Cookies e tecnologias semelhantes</a></li>
            <li><a href="#direitos">9. Direitos dos titulares</a></li>
            <li><a href="#seguranca">10. Segurança da informação e resposta a incidentes</a></li>
            <li><a href="#atualizacoes">11. Atualizações desta política</a></li>
            <li><a href="#contato">12. Encarregado de Proteção de Dados (DPO) e contato</a></li>
          </ol>
        </nav>

        <main>
          <p className={styles.lead}>
            Esta política descreve como a <strong>Operadora</strong> — empresa responsável
            pelo SGS — trata dados pessoais no âmbito da plataforma. A qualificação como
            controladora ou operadora depende da atividade de tratamento concretamente
            realizada em cada operação. Quando o <strong>Cliente</strong> insere dados de
            trabalhadores em rotinas de SST, a Operadora atua como operadora e o Cliente é
            o controlador. Esta política deve ser lida em conjunto com o contrato comercial,
            eventuais Acordos de Processamento de Dados (DPAs) e as instruções formais do
          ...
          <section id="escopo" className={styles.section}>
            ...
            <p><strong>Quando atuamos como controladores:</strong> definimos finalidade,
            meios e decisões sobre tratamento relacionado à nossa operação institucional:
            segurança da plataforma, faturamento, marketing B2B, suporte e gestão de contas.</p>
            <p><strong>Quando atuamos como operadores:</strong> tratamos dados inseridos pelo
            Cliente para gerir SST, treinamentos, evidências, documentos e rotinas
            ocupacionais — conforme contrato e instruções válidas do Cliente. Para o cenário
            de operador, a empresa contratante é a controladora. Pedidos de titulares
            relacionados a esses dados devem ser encaminhados preferencialmente ao controlador.</p>
          </section>

          <section id="dados" className={styles.section}>
            <h2>2. Categorias de dados tratados</h2>
            <p>
              Tratamos apenas os dados adequados, pertinentes e necessários para prestar o
              serviço, manter a segurança do ambiente e cumprir obrigações contratuais, legais
              e regulatórias (princípio da necessidade, Art. 6, III, LGPD).
            </p>
            <ul>
          ...
          <section id="saude" className={styles.section}>
            <h2>3. Dados de saúde ocupacional (Art. 11, LGPD)</h2>
            <p>
              O SGS pode processar dados de saúde inseridos pelo Cliente, como exames médicos
              periódicos, atestados, CATs e laudos ocupacionais. Esses dados são classificados
              como <strong>dados sensíveis</strong> nos termos do art. 5, II e do art. 11 da LGPD.
            </p>
            <ul>
              <li>
                <strong>Base legal aplicável:</strong> definida pelo controlador conforme o caso
                concreto, normalmente com fundamento no cumprimento de obrigação legal ou
                regulatória (art. 11, II, &ldquo;a&rdquo;) e no exercício regular de direitos,
                inclusive em contrato (art. 11, II, &ldquo;d&rdquo;). A tutela da saúde
                (art. 11, II, &ldquo;f&rdquo;) somente se aplica quando atendidos os requisitos
                legais dessa hipótese.
              </li>
              <li>
                <strong>Acesso restrito:</strong> os dados de saúde são acessíveis apenas a
                usuários autorizados pelo Cliente dentro da mesma organização (isolamento
                multi-tenant por RLS).
              </li>
              <li>
                <strong>Uso em IA:</strong> dados de saúde não devem ser enviados a provedores
                de IA por padrão. Qualquer exceção depende de habilitação expressa do Cliente,
                necessidade demonstrada, base legal adequada, minimização e salvaguardas técnicas
                e contratuais.
              </li>
              <li>
                <strong>Retenção:</strong> conforme legislação trabalhista e de saúde ocupacional
                aplicável, e instrução do controlador (Cliente).
              </li>
            </ul>
          </section>

          <section id="bases" className={styles.section}>
          ...
          <section id="compartilhamento" className={styles.section}>
            ...
            <p>
              Não comercializamos dados pessoais. Compartilhamos dados apenas com suboperadores
              necessários para a execução do serviço. A contratação, região, retenção e
              salvaguardas de cada provedor devem ser mantidas em evidência operacional antes
              de qualquer declaração de conformidade plena.
            </p>
            <div className={styles.tableWrap}>
              <table className={styles.dataTable}>
                <thead>
            ...
            <p>
              Mantemos internamente um inventário de suboperadores, com revisão periódica de
              finalidade, categoria de dados, região, retenção, DPA e mecanismo de
              transferência internacional. Também podemos compartilhar dados com autoridades
              públicas, órgãos regulatórios ou terceiros legitimados quando exigido por lei,
              ordem judicial ou investigação formal.
            </p>
          </section>
          ...
          <section id="transferencias" className={styles.section}>
            ...
            <p>
              Alguns suboperadores processam dados fora do Brasil. Adotamos as seguintes
              salvaguardas para cada transferência:
            </p>
            <ul>
              <li>
                <strong>Mecanismo jurídico válido:</strong> decisão de adequação da ANPD,
                cláusulas-padrão contratuais aprovadas pela ANPD, cláusulas específicas, normas
                corporativas globais ou outra hipótese admitida pelo art. 33 da LGPD, conforme
                o caso.
              </li>
              <li>
                <strong>Governança contratual:</strong> DPA, definição de papéis, finalidade,
                subcontratação, retenção, segurança e apoio ao exercício de direitos devem
                constar do instrumento aplicável.
              </li>
              <li>
                <strong>Minimização técnica:</strong> somente os dados necessários devem ser
                transferidos. Dados sensíveis exigem avaliação reforçada e não devem ser
                enviados quando a finalidade puder ser atendida por dados agregados,
                anonimizados ou pseudonimizados.
              </li>
              <li>
                <strong>Segurança e diligência:</strong> certificações e relatórios de auditoria
                podem apoiar a avaliação do fornecedor, mas não substituem o mecanismo jurídico
                exigido para a transferência.
              </li>
            </ul>
          </section>
          ...
          <section id="retencao" className={styles.section}>
            ...
            <p>
              Os dados são mantidos pelo tempo necessário para cumprir a finalidade, respeitar
              obrigações legais e garantir a continuidade operacional.
            </p>
            <div className={styles.tableWrap}>
              <table className={styles.dataTable}>
                <thead>
            ...
            <p>
              ...
              Após esse prazo, os dados são bloqueados, eliminados ou anonimizados conforme
              viabilidade técnica, obrigação legal, backups e retenções exigidas por lei.
            </p>
          </section>
          ...
          <section id="direitos" className={styles.section}>
            ...
            <p>
              Os direitos abaixo podem ser exercidos contra o controlador competente. Quando a
              Operadora atuar como operadora, auxiliará o Cliente na execução desses pedidos
            ...
            <p>
              Para dados diretamente controlados pela Operadora, envie sua solicitação para{' '}
              {privacyHref ? (
                <a href={privacyHref}>{privacyChannel}</a>
              ) : (
                privacyChannel
              )}
              . A confirmação de existência ou o acesso em formato simplificado é atendido
              imediatamente quando possível; a declaração clara e completa é fornecida em até
              15 dias, contados do requerimento, nos termos do art. 19 da LGPD.
            </p>
          </section>
          ...
          <section id="seguranca" className={styles.section}>
            ...
            <p>
              Adotamos medidas técnicas e administrativas compatíveis com o risco da operação,
              observando boas práticas de mercado e monitoramento contínuo.
            </p>
            <ul>
            ...
            <p>
              Em caso de incidente que possa acarretar risco ou dano relevante, a Operadora
              comunicará o controlador sem demora indevida e apoiará a apuração. Compete ao
              controlador comunicar a ANPD e os titulares, quando aplicável, em até 3 dias
              úteis contados do conhecimento de que o incidente afetou dados pessoais,
              ressalvados prazos específicos.
            </p>
          </section>
          ...
          <section id="atualizacoes" className={styles.section}>
            ...
            <p>
              ...
              contratuais ou tecnológicas. Alterações materiais serão comunicadas por meio
              adequado, e a versão vigente permanecerá identificada no cabeçalho. Quando a
              mudança depender de consentimento, a nova manifestação será solicitada antes do
          ...
          <section id="contato" className={styles.section}>
            ...
            <ul>
              ...
              {dpoPhone ? (
                <li>
                  ...
                  <a href={`tel:${dpoPhone}`}>{dpoPhone}</a>
                </li>
              ) : null}
            ...
            <p>
              O titular também pode peticionar perante a Autoridade Nacional de Proteção de
              Dados (ANPD) pelos canais oficiais em{' '}
              <a
