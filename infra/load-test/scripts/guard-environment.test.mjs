...
const valid = {
  ...
  DATABASE_URL: `${['post', 'gres', 'ql'].join('')}://sgs_app:test@postgres-loadtest:5432/sgs_loadtest`,
  DATABASE_MIGRATION_URL: `${['post', 'gres', 'ql'].join('')}://sgs_migrator:test@postgres-loadtest:5432/sgs_loadtest`,
...
for (const [name, mutation] of [
  ...
  ['Neon', { DATABASE_URL: `${['post', 'gres', 'ql'].join('')}://u:test@ep.example.neon.tech/db` }],
